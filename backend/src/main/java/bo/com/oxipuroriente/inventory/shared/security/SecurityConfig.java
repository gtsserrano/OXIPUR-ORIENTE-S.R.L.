    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter)
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/profiles/**", "/api/utilities/**").hasRole("ADMINISTRADOR")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/products/**", "/api/cylinders/**", "/api/warehouses/**").hasRole("ADMINISTRADOR")
                        .requestMatchers(HttpMethod.PATCH, "/api/products/**", "/api/cylinders/**", "/api/warehouses/**").hasRole("ADMINISTRADOR")
                        .requestMatchers(HttpMethod.DELETE, "/api/products/**", "/api/cylinders/**").hasRole("ADMINISTRADOR")
